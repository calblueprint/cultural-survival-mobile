    ...
    <ScrollView style={styles.container}>
      ...
      <ViewContainer>
        <GrantCard
          ...
          deadline={"10/22/2023"}
          description={
            "Brief: Providing opportunities for international Indigenous radio stations to strengthen their broadcast infrastructure and systems. The Indigenous Community /Media Fund also provides training opportunities in journalism, broadcasting."
          }
        />
        <GrantCard
          amount={"$3000"}
          ...
          deadline={"1/18/2023"}
          description={
            "Brief: KOEF provides small grants ranging between $500 and $5,000 USD to grassroots Indigenous-led organizations, collectives, and traditional governments in their self-determined development projects based on their Indigenous values."
          }
        />
        <GrantCard
          amount={"$3050"}
